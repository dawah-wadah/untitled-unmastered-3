...
const dispatcher = (foo) => {
  const orderedDrones = __WEBPACK_IMPORTED_MODULE_0__lib_drone_js__["a" /* default */].soonestDrones(foo.drones);
  const orderedPackages = __WEBPACK_IMPORTED_MODULE_0__lib_drone_js__["a" /* default */].soonestPackages(foo.packages);
